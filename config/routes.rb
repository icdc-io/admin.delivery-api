Rails.application.routes.draw do
  namespace :api do
    namespace :v1 do
      ...
      get '/services/:service_name/versions', to: 'versions#get_downgrade_versions', constraints: { :service_name => /[0-z\.]+/ }
      get '/services/:service_name/latest', to: 'versions#get_installed_github_versions', constraints: { :service_name => /[0-z\.]+/ }
