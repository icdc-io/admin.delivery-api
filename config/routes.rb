Rails.application.routes.draw do
  ...
  namespace :api do
    namespace :v1 do
      ...
      put     '/services/:service_name/update',            to: 'services#update',                        constraints: { :service_name => /[0-z\.\-]+/ }
      # TODO: Remove
      post    '/service/:service_name/install',            to: 'services#create_old',                    constraints: { :service_name => /[0-z\.\-]+/ }
      delete  '/service/:service_name',                    to: 'services#delete_old',                    constraints: { :service_name => /[0-z\.\-]+/ }
      put     '/service/:service_name/release',            to: 'services#upgrade_old',                   constraints: { :service_name => /[0-z\.\-]+/ }
      put     '/service/:service_name/downgrade',          to: 'services#downgrade_old',                 constraints: { :service_name => /[0-z\.\-]+/ }
